...
<script src="js/TestimonialAJAX.js"></script>
<body>
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <img src="pictures/1.jpg" alt="First slide">
                    <div class="container">
 ...
 <div id="wrapper" class="top-section">
    <div id="bod-wrap" class="container"> <!-- /.container -->
        ...
        <div class="container marketing">
            ...
            <?php include("php/endorsments.php"); ?>
   ...
   <div id="wrapper" class="helpus-section">
    <div id="bod-wrap" class="container"> 
        ...
        <div id="footer" class="container"> 
            <p class="pull-right"><a id="r" href="#">Back to top</a></p>
            <p>&copy; 2014 Jam Electrical, Inc. &middot; <a href="#">Privacy</a> &middot; <a href="#">Terms</a></p>
        </div>
        </footer>
...
//onClick nav "essex & london" scroll to location 
